        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    Activity for <span class="font-bold text-primary"><?php echo e(\Carbon\Carbon::parse($date)->format('D, d M Y')); ?></span>
                </p>
            </div>

            <form action="<?php echo e(route('admin.report')); ?>" method="GET" class="flex items-center gap-2 bg-white dark:bg-gray-800 p-2 rounded-xl border border-border-light dark:border-gray-700 shadow-sm">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 mb-8">
            ...
            <div class="flex flex-col gap-2 rounded-xl border border-border-light bg-white p-6 dark:bg-gray-800 shadow-sm hover:border-primary transition duration-300">
                ...
                <div class="flex items-center justify-between">
                    <p class="text-3xl font-bold text-primary"><?php echo e($totalBoarding); ?></p>
            ...
            <div class="flex flex-col gap-2 rounded-xl border border-border-light bg-white p-6 dark:bg-gray-800 shadow-sm hover:border-blue-400 transition duration-300">
                ...
                <div class="flex items-center justify-between">
                    <p class="text-3xl font-bold text-blue-500"><?php echo e($uniqueStudents); ?></p>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition">
                                <td class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                                    <?php echo e($log->created_at->format('h:i:s A')); ?>

                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex flex-col">
                                        <span class="font-bold text-gray-900 dark:text-white"><?php echo e($log->student_name ?? 'Unknown Student'); ?></span>
                                        <span class="text-xs text-gray-500 dark:text-gray-400 font-mono"><?php echo e($log->matric_no ?? '-'); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <?php if($log->action === 'BOARDING'): ?>
...
<?php /**PATH C:\Users\HP\smartbus-tracker\resources\views/admin/report.blade.php ENDPATH**/ ?>