                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2">
                                            <p class="font-bold text-text-dark dark:text-white">{{ $bus->plate_number }}</p>
                                            <span class="block w-2 h-2 rounded-full {{ $bus->status === 'active' ? 'bg-green-500' : 'bg-red-500' }} animate-pulse"></span>
                                        </div>
                                ...
                                <div class="text-right">
                                    ...
                                    <div class="flex items-center justify-end gap-1">
                                        ...
                                        <span id="bus-count-{{ $bus->id }}" class="text-xl font-bold text-primary">{{ $bus->current_passengers }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
