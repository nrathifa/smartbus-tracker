    ...
    <span class="material-symbols-outlined">menu</span>
      ...
      <div x-show="open" @click.away="open = false"
        ...
        <a href="<?php echo e(url('/admin')); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800">Dashboard</a>
                ...
                <a href="<?php echo e(url('/admin/report')); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800">Report</a>
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const stopIcon = L.icon({
            iconUrl: "<?php echo e(asset('asset/images/bus.png')); ?>",
            iconSize: [32, 32],
            iconAnchor: [16, 16],
            popupAnchor: [0, -16]
        });
                    ...
                    buses.forEach(bus => {
                        ...
                        busMarkers[bus.id] = L.marker([lat, lng], {
                            ...
                            icon: L.divIcon({
                                ...
                                html: '<img src="<?php echo e(asset("asset/images/redbus.png")); ?>" class="moving-bus-img">',
    ...
    <?php $__currentLoopData = $groupedBuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $routeName => $busesInRoute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            ...
            if (str_contains($cleanRouteID, 'ruqayyah')) {
                ...
                $stops = ['Mahallah Salahuddin', 'UIAM (Timur)', 'Kenms UIAM', 'Mahallah Safiyyah', 'UIAM (Selatan)', 'Kaed UIAM', 'Kict UIAM', 'Koe UIAM', 'Koed UIAM', 'UIAM (Utara)', 'Kirkhs UIAM'];
            } else {
                $stops = ['-', '-'];
            }
        ?>

        <template x-if="selectedRoute === 'all' || selectedRoute === '<?php echo e($cleanRouteID); ?>'">
            ...
            <div x-data="{ showStops: false }" class="bg-white dark:bg-background-dark rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-gray-800 dark:text-white flex items-center gap-2">
                            ...
                            <span class="text-xs font-normal text-gray-500 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 px-2 py-0.5 rounded-full">
                                <?php echo e($busesInRoute->count()); ?> Active Bus<?php echo e($busesInRoute->count() > 1 ? 'es' : ''); ?>
                ...
                <div class="divide-y divide-gray-100 dark:divide-gray-700">
                    <?php $__currentLoopData = $busesInRoute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="block p-4 bg-white dark:bg-transparent">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2">
                                            <p class="font-bold text-text-dark dark:text-white"><?php echo e($bus->plate_number); ?></p>
                                            <span class="block w-2 h-2 rounded-full <?php echo e($bus->status === 'active' ? 'bg-green-500' : 'bg-red-500'); ?> animate-pulse"></span>
                                        </div>
                                        <p class="text-xs text-gray-500">Capacity: <?php echo e($bus->capacity); ?> seats</p>
                                    </div>
                                </div>
                                ...
                                <div class="text-right">
                                    ...
                                    <div class="flex items-center justify-end gap-1">
                                        ...
                                        <span id="bus-count-<?php echo e($bus->id); ?>" class="text-xl font-bold text-primary"><?php echo e($bus->current_passengers); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\Users\HP\smartbus-tracker\resources\views/admin/track.blade.php ENDPATH**/ ?>