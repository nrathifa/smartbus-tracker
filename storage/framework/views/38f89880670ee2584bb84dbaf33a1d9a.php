...
<div class="relative flex min-h-screen flex-col overflow-x-hidden">
    ...
    <div
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex flex-col gap-1">
          <p class="text-text-dark dark:text-white text-base font-bold"><?php echo e($bus->plate_number); ?></p>

          <p class="text-gray-600 dark:text-gray-400 text-sm"><?php echo e($bus->route); ?></p>
          ...
          <p class="text-gray-600 dark:text-gray-400 text-sm flex items-center">
            ...
            <?php echo e($bus->current_passengers ?? 0); ?>/<?php echo e($bus->capacity ?? 'N/A'); ?>
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="<?php echo e($statusColor); ?> text-xs font-bold px-2.5 py-1 rounded-full w-max uppercase tracking-wide">
          <?php echo e($bus->status ?? 'Unknown'); ?>

        </span>

        <button @click="openEditForm(<?php echo e($bus->id); ?>)"
                class="text-primary size-9 flex items-center justify-center rounded-full hover:bg-primary/10 transition">
          <span class="material-symbols-outlined">edit</span>
        </button>

        <button @click="busToDelete = <?php echo e($bus->id); ?>; plateToDelete = '<?php echo e($bus->plate_number); ?>'; showDelete = true"
  ...
  <div class="fixed inset-0 z-30 bg-black/50"
    ...
    <div class="absolute bottom-0 left-0 right-0 max-h-[90vh] overflow-y-auto rounded-t-2xl bg-background-light dark:bg-background-dark p-4">
      ...
      <form :action="editing ? '/businfo/' + bus.id : '<?php echo e(route('bus.store')); ?>'" method="POST" class="space-y-6 pt-6">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\HP\smartbus-tracker\resources\views/admin/businfo.blade.php ENDPATH**/ ?>